...
const questionBank = {
    ...
    2: {
        ...
        social: {
            ...
            2: [
                { question: "What is a community?", answers: [{ text: "A group of people living together", correct: true }, { text: "Only one person", correct: false }] }
            ]
        },
        science: {
            1: [
...
function expandQuestionBank() {
    // This function will be called to add more questions
    // For now, we have a starter set above
    return questionBank;
}
